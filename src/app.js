...
app.get("/passwordchangesucc", (req, res) => {
    res.render("/passwordchangesucc");
})
...
// yha se login with google start process  passport.js userControllers userRouter.js(ye main file ha ye passort.js userControlllers.js ko use kar rahi ha or app.js sidha userouter.js ko use kar ahi ha ye three file use ho rahi ha login with google)
