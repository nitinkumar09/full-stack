...
const forget_password = async (req, res) => {
    try {
        ...
        if (userData) {
            const randomString = randomstring.generate(16);  // random string generate kri or us email ke document me niche set kar di isse ye pta chal ajyega ki isne password change kiya ha 
            ...
            res.status(200).render('mailSentSuccess', { userData });
...
const reset_password = async (req, res) => {
    try {
        ...
        if (tokenData) {
            ...
            res.status(201).render("passwordchangesucc");
            return;
        }
        else {
